...
from graphpype.pipelines.nii_to_conmat import (create_pipeline_nii_to_conmat_simple, 
    create_pipeline_nii_to_conmat_seg_template, create_pipeline_nii_to_subj_ROI,
    create_pipeline_nii_to_conmat)

#create_pipeline_nii_to_conmat_no_seg

### path to test data
data_path = os.path.join(os.path.dirname(os.path.realpath(__file__)),"data","data_nii")
...
### indexed ROI mask - should be the same dimestions as the functional data - see compute_indexed_mask
...
def test_nii_to_conmat_simple():
    ...
    wf = create_pipeline_nii_to_conmat_simple(main_path = data_path, pipeline_name = "nii_to_conmat_simple")
...
### test if create_pipeline_nii_to_conmat_no_seg
#def test_nii_to_conmat_labels():

    #wf = create_pipeline_nii_to_conmat_no_seg(main_path = data_path, pipeline_name = "nii_to_conmat_labels")
...
def test_create_pipeline_nii_to_conmat_seg_template():
    ...
    wf = create_pipeline_nii_to_conmat_seg_template(main_path = data_path, pipeline_name = "nii_to_conmat_seg_template")
...
def test_create_pipeline_nii_to_subj_ROI():
    ...
    wf = create_pipeline_nii_to_subj_ROI(main_path = data_path, pipeline_name = "nii_to_subj_ROI")
...
def test_create_pipeline_nii_to_conmat():
    ...
    wf = create_pipeline_nii_to_conmat(main_path = data_path, pipeline_name = "nii_to_conmat_full")
