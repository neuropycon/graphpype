# -*- coding: utf-8 -*-
#
# graphpype documentation build configuration file, created by
...
html_theme_options = {
    ...
    'navbar_links': [
        ...
        ("API", "api"),
        ("Tutorial", "tutorial"),
        ("Github", "https://github.com/neuropycon/graphpype", True),
    ],
...
htmlhelp_basename = 'graphpypedoc'
...
latex_documents = [
    (master_doc, 'graphpype.tex', 'graphpype Documentation',
...
man_pages = [
    (master_doc, 'graphpype', 'graphpype Documentation',
     [author], 1)
]
